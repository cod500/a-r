...
(function(){
  const slides = [
    { year: '1774–1776', text: 'Over the course of at least nine councils, the <span class="vocab-wrapper" tabindex="0" data-tippy-content-id="tooltip-grand-council"><span class="vocab">Grand Council</span><img src="/nk360/american-revolution-perseverance/assets/images/info_dark.svg" alt="vocab icon" class="vocab-icon"></span> of the Haudenosaunee declare themselves neutral.' },
    { year: 'August 1775 and June 1776', text: 'American representatives request Haudenosaunee leaders stay out of the growing Revolutionary conflict.' },
    { year: '1777', text: 'British representatives appeal to Haudenosaunee leaders to join them in the fight against the Americans.' }
  ];
