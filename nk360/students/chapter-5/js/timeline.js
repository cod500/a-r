...
(function(){
  const slides = [
    { year: '1783', text: 'Despite supporting both sides, the Haudenosaunee are excluded from the <span class="vocab-wrapper" tabindex="0" data-tippy-content-id="tooltip-treaty"><span class="vocab">Treaty</span><img src="/nk360/american-revolution-perseverance/assets/images/info_dark.svg" alt="vocab icon" class="vocab-icon"></span> of Paris between the British and Americans that ends the American Revolution. The British also sign over Haudenosaunee land to the Americans. This is a huge shock to the Haudenosaunee, who had never agreed to give up land.' },
    {
  year: '1784',
  text: `• Seneca, Cayuga, Onondaga, and Mohawk representatives sign the Treaty of Fort Stanwix ceding land. Many are angry about the treaty. <br>
• Many Haudenosaunee who allied with Britain decide to leave the United States after the war. They move onto a piece of land in Canada, called the Haldimand Tract, that was reserved for them by the British government.`
},

    { year: '1794', text: 'The Haudenosaunee pressure the Americans to negotiate a new treaty. The Treaty of Canandaigua recognizes the nation-to-nation relationship between the two sovereign governments.' }
  ];
